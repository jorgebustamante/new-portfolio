...
const ProjectsWide = () => {
  ...
  const data = useStaticQuery(graphql`
    query {
      ...
      brownie: file(absolutePath: { regex: "/brownie.PNG/" }) {
        ...projectImage
      }
          ...
          <div className="scrolling-wrapper">
            <Slider {...settings}>
              <div className="Item">
                <div
                  id="proj1.5"
                  className="box has-text-centered scrollbox p1"
                >
                      ...
                      <div className="content">
                        <div className="card-background">
                          ...
                          <div className="card-text">
                            ...
                            <p className="project-body">
                              Community oriented Web app for Trading and
                              bartering goods.
                            </p>
                    ...
                    <div className="media-content">
                      <div className="content">
                        <div className="card-background">
                          ...
                          /> */}
                           <Img
                            fluid={data.brownie.childImageSharp.fluid}
                            imgStyle={{
                              maxWidth: '100%',
                            }}
                          />
                      ...
                      <div className="content">
                        <div className="card-background">
                          ...
                          <div className="card-text">
                            ...
                            <p className="project-body">
                              To-do list logic web app using Sequelize for
